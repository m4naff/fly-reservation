package com.fly.reservationservice.filter;

import com.fly.reservationservice.client.UserServiceClient;
import com.fly.reservationservice.model.auth.Token;
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if(Token.isBearerToken(authorizationHeader)){
            ...
            try{
                ...
                log.debug("Token validation succeed for request: {}", request.getRequestURI());
                ...
                log.error("Token validation failed for request: {}", request.getRequestURI());
