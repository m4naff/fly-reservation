package com.fly.reservationservice.model.common.entity;

import com.fly.reservationservice.model.auth.enums.TokenClaims;
 ...
 * Provides automatic population of audit fields using jpa annotations
 */
@Getter
@Setter
@AllArgsConstructor
