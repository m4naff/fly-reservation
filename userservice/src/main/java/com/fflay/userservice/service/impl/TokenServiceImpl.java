...
import com.fflay.userservice.config.TokenConfigurationParameter;
import com.fflay.userservice.model.user.Token;
import com.fflay.userservice.model.user.enums.TokenClaims;
import com.fflay.userservice.model.user.enums.TokenType;
...
public class TokenServiceImpl implements TokenService {
    TokenConfigurationParameter tokenConfigurationParameter;
    ...
    public void verifyAndValidate(final String jwt) {
        try {
            ...
            //Log the claims for debug purposes
            ...
            throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "Error validating token", e);
        }
    }
