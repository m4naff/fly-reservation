...
import com.fflay.userservice.exception.UserStatusNotValidException;
...
import com.fflay.userservice.service.RefreshTokenService;
import com.fflay.userservice.service.TokenService;
...
public class RefreshTokenServiceImpl implements RefreshTokenService {
    ...
    public Token refreshToken(TokenRefreshRequest tokenRefreshRequest) {
        ...
        final String adminId = tokenService
                ...
                .getId();
        var userEntityFromDB = userRepository.findById(adminId)
                .orElseThrow(UserNotFoundException::new);
        this.validateUserStatus(userEntityFromDB);
        return tokenService.generateToken(userEntityFromDB.getClaims(),tokenRefreshRequest.getToken());
    }
