package com.fflay.userservice.controller;

import com.fflay.userservice.model.common.dto.response.CustomResponse;
import com.fflay.userservice.model.user.Token;
import com.fflay.userservice.model.user.dto.request.LoginRequest;
import com.fflay.userservice.model.user.dto.request.RegisterRequest;
import com.fflay.userservice.model.user.dto.request.TokenInvalidateRequest;
import com.fflay.userservice.model.user.dto.request.TokenRefreshRequest;
import com.fflay.userservice.model.user.dto.response.TokenResponse;
import com.fflay.userservice.model.user.mapper.TokenToTokenResponseMapper;
import com.fflay.userservice.service.*;
...
public class UserController {
    ...
    TokenToTokenResponseMapper tokenToTokenResponseMapper = TokenToTokenResponseMapper.initialize();
    ...
    public CustomResponse<Void> register(@RequestBody RegisterRequest registerRequest) {
     ...
     */
    @PostMapping("/logout")
    public CustomResponse<Void> logoutUser(@RequestBody @Valid final TokenInvalidateRequest tokenInvalidateRequest) {
    ...
    public ResponseEntity<UsernamePasswordAuthenticationToken> authenticate(@RequestParam String token) {
